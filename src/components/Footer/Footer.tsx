        ...
        <div className={styles.grid}>
          <div>
            ...
            <p className={styles.text}>
              Learn with interactive quizzes, educational tools, and skill-based
              challenges. Built for students, learners, and knowledge
              enthusiasts to improve daily learning in a fun way.
            </p>
          </div>
          ...
          <div>
            ...
            <div className={styles.links}>
              ...
              <Link href="/refer-earn">Invite Friends</Link>
          ...
          <div>
            ...
            <p className={styles.indiaText}>Made with ❤️ in India</p>
          </div>
        </div>
